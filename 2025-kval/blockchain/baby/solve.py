...
with open("container/abi/Store.json", "r") as openfile:
    store_abi = json.load(openfile)

with open("container/abi/Setup.json", "r") as openfile:
...
contract.functions.buyItem(1).transact(
    {"from": my_addr, "value": 50 * 10**18, "gas": 1000000}
)
